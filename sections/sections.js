Vvveb.Sections.add("minimal-personal-portfolio/about", {
    name: "About",
    image: Vvveb.themeBaseUrl + "/screenshots/minimal-personal-portfolio/about-thumb.jpeg",
    html: `<section class="section_padding about-me" id="about">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6 order-2 order-md-2 order-lg-1 text-center text-lg-left mb-0">
				<div class="about-me__image mb-0">
					<img src="assets/images/about/me.jpg" alt="Kevin" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-6 order-1 order-md-1 order-lg-2 mb-5 mb-md-5 mb-lg-0">
				<div class="about-me__info">
					...
					<div class="d-flex">
						<button class="btn me-2">Hire Me</button>
						<button class="btn btn_white">Download CV</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="about-me__dots">
		<img src="assets/images/about/dots.png" alt="Dots" class="img-fluid">
	</div>
	<div class="about-me__triangle">
		<img src="assets/images/about/triangle.png" alt="Triangle" class="img-fluid">
	</div>
</section>
`
});Vvveb.Sections.add("minimal-personal-portfolio/banner", {
    name: "Banner",
    image: Vvveb.themeBaseUrl + "/screenshots/minimal-personal-portfolio/banner-thumb.jpeg",
    html: `<section class="banner-area">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6">
			...
			<div class="col-lg-6 text-md-center mt-5 mt-md-0">
				<img src="assets/images/banner/hero_image.png" alt="Person" class="img-fluid overflow-hidden img_sm">
				<div class="dots-image">
					<img src="assets/images/banner/dots.png" alt="Dots" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
...
`
});Vvveb.Sections.add("minimal-personal-portfolio/blog", {
    name: "Blog",
    image: Vvveb.themeBaseUrl + "/screenshots/minimal-personal-portfolio/blog-thumb.jpeg",
    html: `<section class="section_padding blog pb-0" id="blog">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h2 class="section_heading text-center">Blog</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-6">
				<div class="blog-item">
					...
					<div class="blog-item__info">
						<a class="title" href="#"> Getting Started With Adobe Xd.</a>
						<a class="category" href="#"> Category Design </a>
						<div class="blog-item__bottom">
							...
							<div class="blog_comments">
								<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
									...
									<path id="Comment_Icon" data-name="Comment Icon" class="cls-1"
			...
			<div class="col-lg-6">
				<div class="blog-item mb-0">
					...
					<div class="blog-item__info">
						<a class="title" href="#"> My Work Space Set-up in 2020. </a>
						<a class="category" href="#"> Category Design </a>
						<div class="blog-item__bottom">
							<div class="blog_date">
								<svg id="Dates_Icon" data-name="Dates Icon" xmlns="http://www.w3.org/2000/svg"
...
`
});Vvveb.Sections.add("minimal-personal-portfolio/contact", {
    name: "Contact",
    image: Vvveb.themeBaseUrl + "/screenshots/minimal-personal-portfolio/contact-thumb.jpeg",
    html: `<section class="section_padding contact" id="contact" data-v-component-plugin-contact-form-form data-v-storage="database" data-v-name="contact-us-home">
	<div class="container">
		<div class="row">
			<div class="col-12">
			...
			<span aria-hidden="true">
				<!-- <i class="la la-times"></i> -->
					...
					<form action="" method="post">
						...
						<input type="text" name="firstname" class="form-control" id="first-name-input" placeholder="First Name" required>
						<input type="text" name="lastname" class="form-control" id="last-name-input" placeholder="Last Name" required>
						<input type="email"  name="email" class="form-control" id="email-input" placeholder="Email" required>
						<input type="text" name="subject" class="form-control" id="last-name-input" placeholder="Subject" required>
						...
						<button type="submit" type="submit" class="btn">Send Message</button>
					</form>
				</div>
			</div>
		</div>
...
`
});Vvveb.Sections.add("minimal-personal-portfolio/footer", {
    name: "Footer",
    image: Vvveb.themeBaseUrl + "/screenshots/minimal-personal-portfolio/footer-thumb.jpeg",
    html: `<div class="copyright">
	<p class="text-center"><span>&copy;</span> 2024-Kevin Gilbert - Powered by <a href="https://www.vvveb.com">Vvveb</a></p>
</div>
`
});Vvveb.Sections.add("minimal-personal-portfolio/header", {
    name: "Header",
    image: Vvveb.themeBaseUrl + "/screenshots/minimal-personal-portfolio/header-thumb.jpeg",
    html: `<header>
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<nav class="navbar navbar-expand-md menu">
					<div class="menu__logo" data-v-component-site>	
						<a class="navbar-brand" href="/" data-v-url-params='{"host":"www.*.*"}'><span class="visually-hidden">Logo</span>
						   <img src="./assets/images/icon/01.png" alt="Site logo" loading="lazy" class="logo-default" data-v-site-logo>
						   <!--
						   <img src="./images/header-logo.svg" alt="Site logo sticky" loading="lazy" class="logo-sticky" data-v-site-logo-sticky>
						   <img src="./images/icon-01.png" alt="Site logo dark" loading="lazy" class="logo-default-dark" data-v-site-logo-dark>
						   <!--
...
`
});Vvveb.Sections.add("minimal-personal-portfolio/portfolio", {
    name: "Portfolio",
    image: Vvveb.themeBaseUrl + "/screenshots/minimal-personal-portfolio/portfolio-thumb.jpeg",
    html: `<section class="my-portfolio" id="portfolio" style="background-image: url(assets/images/portfolio/bg.png);">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h2 class="section_heading text-center">My Portfolio</h2>
			</div>
		</div>
		<div class="row flex-wrap">
			<div class="column">
				<img src="assets/images/portfolio//01.jpg" alt="Project" class="img-fluid">
				<img src="assets/images/portfolio//04.jpg" alt="Project" class="img-fluid">
				<img src="assets/images/portfolio//07.jpg" alt="Project" class="img-fluid">
			</div>

			<div class="column">
				<img src="assets/images/portfolio//02.jpg" alt="Project" class="img-fluid">
				<img src="assets/images/portfolio//05.jpg" alt="Project" class="img-fluid">
				<img src="assets/images/portfolio//08.jpg" alt="Project" class="img-fluid">
			</div>

			<div class="column">
				<img src="assets/images/portfolio//03.jpg" alt="Project" class="img-fluid">
				<img src="assets/images/portfolio//06.jpg" alt="Project" class="img-fluid">
				<img src="assets/images/portfolio//09.jpg" alt="Project" class="img-fluid">
			</div>
...
`
});Vvveb.Sections.add("minimal-personal-portfolio/services", {
    name: "Services",
    image: Vvveb.themeBaseUrl + "/screenshots/minimal-personal-portfolio/services-thumb.jpeg",
    html: `<section class="section_padding services" id="services">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h2 class="section_heading text-center">My Services</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-4">
...
`
});Vvveb.Sections.add("minimal-personal-portfolio/testimonials", {
    name: "Testimonials",
    image: Vvveb.themeBaseUrl + "/screenshots/minimal-personal-portfolio/testimonials-thumb.jpeg",
    html: `<section class="section_padding testimonials pb-0">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h2 class="section_heading text-center">Testimonials</h2>
				<div class="testimonials-dots">
					<img src="assets/images/testimonial/dots.png" alt="Dots" class="img-fluid">
				</div>
			</div>
		</div>
		<div class="row align-items-center">
			<div class="col-lg-5">
				<div class="swiper-container">
					...
					<div class="testimonial-left__buttons">
						<button class="btn btn_prev"> <i class="icofont-long-arrow-left"></i> Prev </button>
...
`
	...
	Vvveb.SectionsGroup["Minimal personal portfolio"] = ["minimal-personal-portfolio/about","minimal-personal-portfolio/banner","minimal-personal-portfolio/blog","minimal-personal-portfolio/contact","minimal-personal-portfolio/footer","minimal-personal-portfolio/header","minimal-personal-portfolio/portfolio","minimal-personal-portfolio/services","minimal-personal-portfolio/testimonials"];
